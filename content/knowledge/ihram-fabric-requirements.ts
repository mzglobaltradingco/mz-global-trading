...
## The Religious Requirements — Non-Negotiable Specifications

Ihram for male pilgrims consists of two pieces of white, unsewn textile:

1. **Ridaa (رداء):** The upper garment, draped over the left shoulder and under the right arm
2. **Izaar (إزار):** The lower garment, wrapped around the waist like a sarong

**What Islamic law requires of the fabric:**
...
|---|---|---|
| 300–350 GSM | Lightweight terry | Summer Hajj (June–August), Umrah |
...
**Whiteness:** Optical brightening agents (OBA) are used in most white terry production. For Ihram: specify whiteness index ≥ 80 CIE. Confirm the OBA used is not fluorescent pink or yellow-cast — some OBAs produce a visible tint under UV lighting (halogen and LED lighting in mosques and airports).
...
|---|---|---|
| Ridaa (upper) | 100×200 cm (40×79 in) | Minimum width for full shoulder and chest coverage |
| Izaar (lower) | 100×200 cm (40×79 in) | Must wrap fully around the waist with adequate overlap |
| Extended (large) | 110×220 cm (43×87 in) | For taller or larger pilgrims |
| Youth | 90×180 cm (35×71 in) | For teenage and juvenile pilgrims |

Both pieces are typically the same size in most commercial Ihram sets — simplifying production and packing. Specify the size clearly; size variation is the primary complaint in pilgrim feedback after colour deviation.
