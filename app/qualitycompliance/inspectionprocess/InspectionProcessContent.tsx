  ...
  return (
    <>
      ...
      <section className="py-10 bg-gray-50 border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-gold text-xs font-semibold tracking-[0.2em] uppercase mb-5">Sourcing Guide</p>
          <Link
            prefetch={false}
            href="/guides/sourcing-best-practices-pre-shipment-inspection/"
            className="group flex items-start gap-4 bg-white hover:bg-navy-900/5 rounded-xl p-5 border border-gray-100 hover:border-gold/30 transition-all max-w-xl"
          >
            ...
            <div>
              <p className="text-navy-900 font-semibold text-sm group-hover:text-gold transition-colors leading-snug">Sourcing Best Practices: Pre-Shipment Inspection</p>
              <p className="text-gray-500 text-xs mt-1 leading-relaxed">Step-by-step best practices for organising and evaluating pre-shipment inspections in Pakistan&apos;s textile factories.</p>
            </div>
          </Link>
        </div>
      </section>
