              ...
              <div className="grid grid-cols-4 gap-2 flex-1">
                {COLOUR_PROGRAMME.slice(0, 8).map((c) => (
                  <div key={c.name} className="flex flex-col items-center gap-1.5">
                    <div className={`w-10 h-10 rounded-xl ${c.swatch} shadow-xs`} />
      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link prefetch={false} href="/knowledge/medical-scrubs-fabric-guide/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📚</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Knowledge Hub</p>
              <p className="font-semibold text-navy-900">Medical Scrubs Fabric Guide: Poly-Cotton, 4-Way Stretch & Anti-Microbial</p>
              <p className="text-xs text-gray-500 leading-relaxed">Fabric construction comparison, wash durability, hospital colour-coding and certification requirements.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Read Article →</span>
            </Link>
            <Link prefetch={false} href="/guides/sourcing-medical-scrubs-pakistan/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📄</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Sourcing Guide</p>
              <p className="font-semibold text-navy-900">Sourcing Medical Scrubs from Pakistan: Fabric, Colours & Custom Embroidery</p>
              <p className="text-xs text-gray-500 leading-relaxed">Step-by-step guide — fabric selection, colour programme, embroidery specification and size distribution.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Read Guide →</span>
            </Link>
            <Link prefetch={false} href="/downloads/scrubs-size-spec-template/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">⬇️</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Downloads</p>
              <p className="font-semibold text-navy-900">Medical Scrubs Size & Specification Template (XS–5XL)</p>
              <p className="text-xs text-gray-500 leading-relaxed">Document fabric, wash standard, colour Pantone references, embroidery and size distribution before your RFQ.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {PROCESS_STEPS.map((step, i) => (
                <motion.div key={step.num} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, delay: i * 0.07 }}
                  className="bg-white rounded-2xl p-6 border border-gray-100 shadow-xs" style={{ boxShadow: "inset 0 1px 0 rgba(255,255,255,0.8), 0 2px 8px rgba(0,0,0,0.06)" }}>
