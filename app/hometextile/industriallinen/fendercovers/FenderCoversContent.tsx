    ...
    <div className="overflow-x-clip">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/hero/hero-home-textiles.webp" fill alt="Pakistan fender cover manufacturer — knitted terry stretch non-scratch automotive fender covers for dealerships and body shops worldwide" className="object-cover" priority sizes="100vw" />
      ...
      <section className="bg-gray-50 py-8 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap gap-4 justify-center">
          {[
            { label: "Submit an RFQ", href: "/rfq/", highlight: true },
            { label: "Industrial Linen Overview", href: "/hometextile/industriallinen/", highlight: false },
            { label: "Shop Towels", href: "/hometextile/industriallinen/shoptowels/", highlight: false },
