      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/knowledge/pillow-cover-fabric-guide/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📚</span>
            ...
            <Link href="/guides/custom-pillow-cover-sourcing/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📄</span>
            ...
            <Link href="/downloads/pillow-cover-size-reference/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">⬇️</span>
          ...
          <AnimatePresence mode="wait">
            <motion.div key={activeConstr} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.2 }}
              ...
              <div className="bg-navy-900 rounded-2xl p-8 flex flex-col justify-between">
                ...
                <Link href="/rfq/" className="mt-8 inline-flex items-center gap-2 bg-gold text-navy-900 font-semibold px-5 py-3 rounded-xl hover:bg-yellow-400 transition-colors text-sm">
                  Request Samples →
                </Link>
              </div>
            </motion.div>
