...
const PAGE_BOXES = [
  { title: "Bedsheets", desc: "Custom flat bedsheets in percale, sateen, jacquard and oxford weave. 200–600 TC range.", image: "/images/hero/hero-bedsheets.webp", alt: "Pakistan bedsheet manufacturer — wholesale percale and sateen flat sheets", href: "/hometextile/bedlinen/bedsheets/", cta: "Explore Bedsheets" },
  { title: "Duvet Covers", desc: "Custom comforter covers in percale and sateen. Button, zip and envelope closure options.", image: "/images/hero/hero-duvet-covers.webp", alt: "Pakistan duvet cover manufacturer — custom comforter covers wholesale", href: "/hometextile/bedlinen/duvetcovers/", cta: "Explore Duvet Covers" },
  { title: "Pillow Covers", desc: "Cotton and linen pillowcases in standard, queen and oxford flange styles.", image: "/images/hero/hero-pillow-covers.webp", alt: "Pakistan pillow cover manufacturer — custom pillowcases wholesale", href: "/hometextile/bedlinen/pillowcovers/", cta: "Explore Pillow Covers" },
  { title: "Cushion Covers", desc: "Decorative cushion covers in woven and embroidered styles for home furnishing markets.", image: "/images/hero/hero-cushion-covers.webp", alt: "Pakistan cushion cover manufacturer — decorative throw pillow covers wholesale", href: "/hometextile/bedlinen/cushioncovers/", cta: "Explore Cushion Covers" },
  { title: "Curtains", desc: "Woven, jacquard and blackout curtains with choice of heading type and lining.", image: "/images/hero/hero-curtains.webp", alt: "Pakistan curtain manufacturer — custom woven and blackout curtains wholesale", href: "/hometextile/bedlinen/curtains/", cta: "Explore Curtains" },
  { title: "Institutional Bedding", desc: "Commercial-grade bedding sets for hotels, hospitals and airlines rated for 200+ wash cycles.", image: "/images/hero/hero-institutional-bedding.webp", alt: "Pakistan institutional bedding manufacturer — hotel and hospital linen wholesale", href: "/hometextile/bedlinen/institutionalbedding/", cta: "Explore Institutional Bedding" },
];
