...
const PAGE_BOXES = [
  { title: "Fitted Sheets", desc: "Elasticated fitted sheets in percale and sateen. Pocket depths to 26 inches for all mattress types.", image: "/images/menu/menu-fittedsheets.webp", alt: "Pakistan fitted sheet manufacturer — deep pocket elasticated sheets for hotels and retail", href: "/hometextile/bedlinen/fittedsheets/", cta: "Explore Fitted Sheets" },
  { title: "Duvet Covers", desc: "Custom duvet covers in percale, sateen and jacquard. Button, zip and envelope closure options.", image: "/images/menu/menu-duvetcovers.webp", alt: "Pakistan duvet cover manufacturer — custom comforter covers for wholesale export", href: "/hometextile/bedlinen/duvetcovers/", cta: "Explore Duvet Covers" },
  { title: "Pillow Covers", desc: "Cotton and linen pillowcases in standard and oxford flange styles with multiple closure options.", image: "/images/menu/menu-pillowcovers.webp", alt: "Pakistan pillow cover manufacturer — custom pillowcases for wholesale buyers", href: "/hometextile/bedlinen/pillowcovers/", cta: "Explore Pillow Covers" },
  { title: "Cushion Covers", desc: "Decorative cushion covers in woven, printed and embroidered styles for home furnishing buyers.", image: "/images/menu/menu-cushioncovers.webp", alt: "Pakistan cushion cover manufacturer — decorative throw pillow covers wholesale", href: "/hometextile/bedlinen/cushioncovers/", cta: "Explore Cushion Covers" },
  { title: "Curtains", desc: "Custom woven, jacquard and blackout curtains with choice of heading type and lining options.", image: "/images/menu/menu-curtains.webp", alt: "Pakistan curtain manufacturer — custom woven and blackout curtains wholesale export", href: "/hometextile/bedlinen/curtains/", cta: "Explore Curtains" },
  { title: "Institutional Bedding", desc: "Commercial-grade bedding sets for hotels, hospitals and airlines rated for 200+ wash cycles.", image: "/images/menu/menu-institutionaltowels.webp", alt: "Pakistan institutional bedding manufacturer — hotel and hospital linen sets wholesale", href: "/hometextile/bedlinen/institutionalbedding/", cta: "Explore Institutional Bedding" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/knowledge/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Bedsheet Buying Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Thread count, weave constructions and size standards for international wholesale bedsheet buyers.</p>
            ...
            <Link href="/guides/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Sourcing process, certification requirements, lead times and factory audit overview for home textiles.</p>
            ...
            <Link href="/downloads/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Bedsheet Spec Sheets &amp; Size Charts</p>
              <p className="text-xs text-gray-500 leading-relaxed">Construction specification sheets, US/UK/EU size charts and certification documentation.</p>
