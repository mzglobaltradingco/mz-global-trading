...
const PAGE_BOXES = [
  { title: "Bedsheets", desc: "Custom flat bedsheets in percale, sateen, jacquard and oxford weave. 200–600 TC for retail and contract programmes.", image: "/images/menu/menu-bedsheets.webp", alt: "Pakistan bedsheet manufacturer — wholesale cotton percale and sateen flat sheets", href: "/hometextile/bedlinen/bedsheets/", cta: "Explore Bedsheets" },
  { title: "Fitted Sheets", desc: "Elasticated fitted sheets with pocket depths from 12 to 26+ inches. Percale and sateen. Hotel and retail specification.", image: "/images/menu/menu-fittedsheets.webp", alt: "Pakistan fitted sheet manufacturer — deep pocket elasticated sheets wholesale", href: "/hometextile/bedlinen/fittedsheets/", cta: "Explore Fitted Sheets" },
  { title: "Duvet Covers", desc: "Custom comforter covers in percale and sateen. Button, zip and envelope closure options for retail and hotel.", image: "/images/menu/menu-duvetcovers.webp", alt: "Pakistan duvet cover manufacturer — custom comforter covers wholesale export", href: "/hometextile/bedlinen/duvetcovers/", cta: "Explore Duvet Covers" },
  { title: "Pillow Covers", desc: "Cotton and linen pillowcases in standard, queen and oxford flange styles. Retail and institutional specifications.", image: "/images/menu/menu-pillowcovers.webp", alt: "Pakistan pillow cover manufacturer — custom pillowcases wholesale export", href: "/hometextile/bedlinen/pillowcovers/", cta: "Explore Pillow Covers" },
  { title: "Cushion Covers", desc: "Decorative cushion covers in woven, embroidered and printed styles for home furnishing and hospitality markets.", image: "/images/menu/menu-cushioncovers.webp", alt: "Pakistan cushion cover manufacturer — decorative throw pillow covers wholesale", href: "/hometextile/bedlinen/cushioncovers/", cta: "Explore Cushion Covers" },
  { title: "Curtains", desc: "Woven, jacquard and blackout curtains with heading and lining options. Hospitality and retail.", image: "/images/menu/menu-curtains.webp", alt: "Pakistan curtain manufacturer — custom woven and blackout curtains wholesale", href: "/hometextile/bedlinen/curtains/", cta: "Explore Curtains" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/knowledge/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Institutional Bedding Buying Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Wash-cycle specifications, fibre blend selection and tender documentation requirements for institutional linen procurement.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Explore Hub →</span>
            </Link>
            <Link href="/qualitycompliance/certifications/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">🏅</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Certifications</p>
              <p className="font-semibold text-navy-900">Our Certification Stack</p>
              <p className="text-xs text-gray-500 leading-relaxed">ISO 9001, OEKO-TEX, BSCI, SA8000 and 7 other standards across our full factory network. Relevant to institutional and government procurement.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">View Certifications →</span>
            </Link>
            <Link href="/downloads/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Institutional Bedding Spec Sheets</p>
              <p className="text-xs text-gray-500 leading-relaxed">TC specifications, size charts, wash performance test reference and certification documentation for tender submissions.</p>
