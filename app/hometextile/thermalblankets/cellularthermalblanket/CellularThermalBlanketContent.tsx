        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap gap-4 justify-center">
            {[
              ...
              { label: "Quality & Compliance", href: "/qualitycompliance/qualitypolicy/", highlight: false },
            ].map((r) => (
              <Link key={r.label} href={r.href}
                className={`inline-flex items-center gap-1.5 text-sm font-semibold px-5 py-2.5 rounded-xl border transition-colors ${r.highlight ? "bg-gold text-navy-900 border-gold hover:bg-yellow-400" : "bg-white text-navy-900 border-gray-200 hover:border-gold hover:text-gold"}`}>
                {r.label}
              </Link>
            ))}
          </div>
