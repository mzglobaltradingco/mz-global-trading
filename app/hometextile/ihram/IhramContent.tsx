...
const PAGE_BOXES = [
  ...
  },
  {
    ...
    image: "/images/hero/hero-table-linen.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-thermal-blankets.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-hospital-linen.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-industrial-linen.webp",
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {MARKET_DATA.map((m, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.08 }}
                className="bg-white rounded-2xl p-6 border border-gray-200 shadow-xs hover:shadow-lg transition-shadow"
                style={{
