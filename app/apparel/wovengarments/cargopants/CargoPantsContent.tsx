        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/knowledge/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Cargo Pants Buying Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Construction guide, finish selection and market positioning for international cargo pants buyers.</p>
            ...
            <Link href="/guides/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Sourcing process, lead times, certification requirements and factory audit overview for woven programmes.</p>
            ...
            <Link href="/downloads/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Construction spec sheets, standard size charts and certification documentation for cargo programmes.</p>
      ...
      <section id="section-sustainability" style={{ backgroundColor: "#F4F7F2" }} className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 pt-8 border-t border-gray-200 flex flex-col sm:flex-row gap-4">
            <Link href="/rfq/" className="inline-flex items-center gap-2 text-white font-semibold px-7 py-3.5 rounded-xl transition-colors" style={{ backgroundColor: "#4a7c59" }}>
      ...
      <section className="bg-gray-50 py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { name: "Denim Jeans", desc: "Rigid, stretch and recycled cotton denim. Stone, acid, enzyme and laser wash.", href: "/apparel/wovengarments/denimjeans/", img: "/images/menu/menu-denimjeans.webp", alt: "Pakistan denim jeans manufacturer — OEM rigid and stretch denim for fashion brands in USA, UK and Europe" },
              ...
              { name: "Pants & Trousers", desc: "Twill chino, canvas, linen and ponte. Business-casual to formal trouser programmes.", href: "/apparel/wovengarments/pantsandtrousers/", img: "/images/menu/menu-pantsandtrousers.webp", alt: "Pakistan pants and trousers manufacturer — OEM chino and formal trousers for business and fashion brands" },
              { name: "Shorts", desc: "Chino, canvas, linen and nylon. Casual, athletic and resort programmes.", href: "/apparel/wovengarments/shorts/", img: "/images/menu/menu-shorts.webp", alt: "Pakistan shorts manufacturer — OEM chino and linen shorts for casual and resort wear brands worldwide" },
            ].map((p) => (
