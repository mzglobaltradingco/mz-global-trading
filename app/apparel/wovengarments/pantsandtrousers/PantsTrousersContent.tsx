        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/knowledge/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="font-semibold text-navy-900">Trouser Buying Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Construction guide, GSM selection and market positioning for international trouser buyers.</p>
            ...
            <Link href="/downloads/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Trouser construction spec sheets, standard size charts and certification documentation.</p>
      ...
      <section id="section-gsm" className="bg-amber-50 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            {GSM_TIERS.map((tier) => (
              <div key={tier.gsm} className={`bg-white rounded-2xl p-7 border-2 ${tier.featured ? "border-gold shadow-lg" : "border-amber-100 shadow-sm"}`}>
                {tier.featured && (
            ...
            {DECO_METHODS.map((d, i) => (
              <div key={d.code} className={`p-8 flex flex-col gap-4 ${i < DECO_METHODS.length - 1 ? "border-b lg:border-b-0 lg:border-r border-gray-200" : ""}`}>
                <div className="flex items-center gap-4">
                  <span className="w-12 h-12 bg-navy-900 text-gold font-bold text-sm flex items-center justify-center rounded-sm shrink-0">{d.code}</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {OEM_FEATURES.map((f, i) => (
              <motion.div
                ...
                className={`bg-white rounded-2xl p-6 shadow-sm border-l-4 ${f.color} flex flex-col gap-3`}
              >
                <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {CERTIFICATIONS.map((c, i) => (
              <motion.div
                ...
                className="border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 hover:border-gold hover:shadow-sm transition-all"
              >
      ...
      <section className="bg-gray-50 py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { name: "Denim Jeans", desc: "Rigid, stretch 98/2, raw and recycled cotton denim. Stone, acid and enzyme wash.", href: "/apparel/wovengarments/denimjeans/", img: "/images/menu/menu-denimjeans.webp", alt: "Pakistan denim jeans manufacturer — OEM rigid and stretch denim for fashion brands in USA, UK and Europe" },
              { name: "Formal & Casual Shirts", desc: "Poplin, oxford, twill and linen. Corporate, fashion and hospitality programmes.", href: "/apparel/wovengarments/formalcasualshirts/", img: "/images/menu/menu-formalcasualshirts.webp", alt: "Pakistan formal and casual shirts manufacturer — OEM woven shirts for corporate and fashion brands worldwide" },
              { name: "Cargo Pants", desc: "Ripstop, canvas and stretch ripstop. Tactical, outdoor and trade workwear.", href: "/apparel/wovengarments/cargopants/", img: "/images/menu/menu-cargopants.webp", alt: "Pakistan cargo pants manufacturer — OEM ripstop and canvas cargo for tactical and outdoor brands" },
              { name: "Shorts", desc: "Chino, canvas, linen and nylon. Casual, athletic and resort wear programmes.", href: "/apparel/wovengarments/shorts/", img: "/images/menu/menu-shorts.webp", alt: "Pakistan shorts manufacturer — OEM chino, canvas and linen shorts for casual and resort brands" },
            ].map((p) => (
