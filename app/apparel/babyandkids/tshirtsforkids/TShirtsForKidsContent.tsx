    ...
    <div className="overflow-x-clip">
      ...
      <section className="relative min-h-[88vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/menu/menu-tshirtsforkids.webp"
            fill
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-navy-900/93 via-navy-900/75 to-navy-900/35" />
        </div>
      ...
      <section className="bg-gray-50 py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: "📚", title: "Knowledge Hub", desc: "Textile industry guides and buying tips", href: "/knowledge/" },
              { icon: "📋", title: "Guides", desc: "Sourcing and compliance guides", href: "/guides/" },
              { icon: "⬇️", title: "Downloads", desc: "Spec sheets and certifications", href: "/downloads/" },
              { icon: "📝", title: "Request a Quote", desc: "Start your kids apparel programme", href: "/rfq/" },
            ].map((r) => (
