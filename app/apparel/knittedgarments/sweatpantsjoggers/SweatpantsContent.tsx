                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">{f.waist}</p>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {DECO_METHODS.map((d) => (
                  <div key={d.code} className="flex items-start gap-2 bg-white rounded-lg px-3 py-2.5 border border-rose-50">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-500 mt-0.5 leading-snug">{d.placement}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link prefetch={false} href="/knowledge/jogger-waistband-guide/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📚</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Knowledge Hub</p>
              <p className="font-semibold text-navy-900">Jogger Waistband Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Drawstring, elastic and rib trim options — construction spec for procurement managers.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Read Article →</span>
            </Link>
            <Link prefetch={false} href="/guides/sourcing-joggers-sweatpants-pakistan/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📄</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Sourcing Guide</p>
              <p className="font-semibold text-navy-900">Sourcing Joggers &amp; Sweatpants Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Fabric, fit, OEM options and certification requirements for international buyers.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">View Guide →</span>
            </Link>
            <Link prefetch={false} href="/downloads/jogger-size-spec-template/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">⬇️</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Downloads</p>
              <p className="font-semibold text-navy-900">Jogger Size Spec Template</p>
              <p className="text-xs text-gray-500 leading-relaxed">Size specification and measurement template for sweatpants and jogger sourcing.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 mt-10">
            ...
            <div className="min-w-[600px]">
              <div className="grid grid-cols-5 bg-white/5 border border-white/10 rounded-t-2xl text-[11px] font-mono font-bold text-gray-500 uppercase tracking-widest px-4 py-3 gap-2">
              ...
              {CONSTRUCTIONS.map((c) => (
                ...
                >
                  ...
                  <span className="text-xs text-gray-500 leading-snug">{c.hand.split(" — ")[0]}</span>
                  <span className="text-xs text-gray-500">{c.best[0]}</span>
          ...
          >
            {[
              ...
              <div key={label}>
                ...
                <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider" dangerouslySetInnerHTML={{ __html: label }} />
              </div>
            ))}
          </div>
          <BackToTop />
            ...
            {GSM_TIERS.map((tier, i) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">{tier.season}</p>
                </div>
              </motion.div>
            ))}
          </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-navy-900 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Export Markets</p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${
                        ...
                        c.tier === "Optional" ? "text-gray-500 bg-gray-100" :
      ...
      <section id="section-export" className="bg-orange-50 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
                ...
                <div key={stage.stage} className="flex-1 relative">
                  <div className="flex sm:flex-col items-start sm:items-center gap-3 sm:gap-2 p-4">
                    ...
                    <div className="sm:text-center">
                      ...
                      <p className="text-[10px] text-gray-500 hidden sm:block">{stage.desc}</p>
                    </div>
                  </div>
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">Working days shown. Sea freight duration varies by destination port.</p>
          </div>
          <BackToTop />
        </div>
      </section>
