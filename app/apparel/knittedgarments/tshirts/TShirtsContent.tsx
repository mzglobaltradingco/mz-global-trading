    ...
    <div className="overflow-x-clip">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/hero/hero-apparel.webp" fill alt="Pakistan t-shirt manufacturer — OEM cotton t-shirts for brands and retailers in USA, UK and Europe" className="object-cover" priority sizes="100vw" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              { name: "Henley Shirts", desc: "Four constructions — single jersey to waffle knit. Casual and performance programmes.", href: "/apparel/knittedgarments/henleyshirts/", img: "/images/menu/menu-henleyshirts.webp", alt: "Pakistan henley shirt manufacturer — OEM single jersey and waffle knit henleys for casual and workwear programmes" },
