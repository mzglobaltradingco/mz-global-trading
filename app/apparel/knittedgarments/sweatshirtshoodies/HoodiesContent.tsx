          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {DECO_METHODS.map((d, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 border border-fuchsia-100 shadow-sm hover:shadow-md transition-all"
      ...
      <section id="section-colors" className="bg-indigo-950 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            {DYE_OPTIONS.map((d) => (
              <div key={d.name} className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/15 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              { name: "Polo Shirts", desc: "Classic piqué, mini piqué and jersey polo. Corporate, golf and hospitality programmes.", href: "/apparel/knittedgarments/poloshirts/", img: "/images/menu/menu-poloshirts.webp", alt: "Pakistan polo shirt manufacturer — OEM piqué and performance polo for corporate and sports brands worldwide" },
              { name: "Henley Shirts", desc: "Four constructions — single jersey to waffle knit. Casual and workwear programmes.", href: "/apparel/knittedgarments/henleyshirts/", img: "/images/menu/menu-henleyshirts.webp", alt: "Pakistan henley shirt manufacturer — OEM single jersey and waffle knit henleys for casual and workwear programmes" },
