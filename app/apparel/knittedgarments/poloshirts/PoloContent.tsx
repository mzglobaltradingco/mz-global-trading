...
<motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="text-gold text-xs font-semibold tracking-[0.2em] uppercase mb-6">Pakistan Knitwear Export</motion.p>
              ...
              <div className="flex flex-col gap-2 flex-1">
                {PROCESS_STEPS.slice(0, 4).map((p) => (
                  <div key={p.num} className="flex items-center gap-2.5">
                    ...
                    <div><p className="text-xs font-semibold text-navy-900">{p.title}</p><p className="text-[9px] text-gray-500">{p.week}</p></div>
                  </div>
                ))}
      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link prefetch={false} href="/knowledge/polo-shirt-pique-guide/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📚</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Knowledge Hub</p>
              <p className="font-semibold text-navy-900">Polo Shirt Piqué Fabric Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Single, double and waffle piqué — construction differences and GSM selection by market.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Read Article →</span>
            </Link>
            <Link prefetch={false} href="/guides/polo-shirt-sourcing-pakistan/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📄</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Sourcing Guide</p>
              <p className="font-semibold text-navy-900">Polo Shirt Sourcing Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Collar types, placket options, branding and certification for international buyers.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">View Guide →</span>
            </Link>
            <Link prefetch={false} href="/downloads/polo-shirt-spec-template/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">⬇️</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Downloads</p>
              <p className="font-semibold text-navy-900">Polo Shirt Specification Template</p>
              <p className="text-xs text-gray-500 leading-relaxed">Fill-in spec for construction, collar, placket, branding and certification.</p>
      ...
      <section id="section-constructions" className="bg-white py-20 lg:py-28 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <p className="text-xs font-semibold tracking-[0.3em] text-gray-500 uppercase mb-2">01 / Constructions</p>
              ...
              <motion.div key={f.code} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }} className="bg-white rounded-2xl overflow-hidden shadow-xs hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest mb-1">Primary Markets</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {GSM_TIERS.map((tier, i) => (
              <motion.div key={tier.gsm} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.12 }} className={`rounded-2xl p-7 border ${tier.featured ? "bg-white text-navy-900 border-white shadow-2xl" : "bg-white/8 border-white/15 text-white backdrop-blur-xs"}`}>
                ...
                <p className={`text-xs font-bold uppercase tracking-wider mb-4 ${tier.featured ? "text-gray-500" : "text-white/40"}`}>{tier.name}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
            {DECO_METHODS.map((d, i) => (
              <motion.div key={d.code} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.09 }} className={`rounded-2xl p-7 flex flex-col gap-5 ${i === 0 ? "bg-navy-900 text-white" : "bg-gray-50 border border-gray-100"}`}>
                ...
                <div>
                  <p className={`text-[10px] font-semibold uppercase tracking-widest mb-2 ${i === 0 ? "text-gray-500" : "text-gray-500"}`}>Compatible With</p>
      ...
      <section id="section-certs" className="bg-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-semibold tracking-[0.3em] text-gray-500 uppercase mb-2">Standards &amp; Certifications</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-1 flex flex-col gap-3">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-1">Incoterms Available</p>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3">Packaging Options</p>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-6">Indicative Timeline</p>
              ...
              return (
                <motion.div key={p.num} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.08 }} className="relative overflow-hidden border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-1">{p.week}</p>
