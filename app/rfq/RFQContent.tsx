        ...
        <div className="bg-gray-50 py-20">
          <div className="max-w-lg mx-auto px-4 text-center">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-xs p-10">
              ...
              <div className="bg-gold/8 border border-gold/20 rounded-xl p-4 text-sm text-gray-700 mb-4 text-left">
              ...
              {/* Webmail / WhatsApp fallback */}
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 text-left">
                <p className="text-blue-900 font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
                  Using webmail or having trouble with your email app?
                </p>
                <p className="text-blue-800 text-xs leading-relaxed mb-3">
                  Gmail, Yahoo Mail, Outlook.com and some corporate webmail clients may not pre-fill the email body correctly. <strong>Download the PDF below</strong> (button is highlighted ↓), then choose one of these options:
                </p>
                <ol className="space-y-2 text-xs text-blue-800">
                  <li className="flex items-start gap-2">
                    <span className="font-bold shrink-0 text-blue-900">1.</span>
                    <span>Attach the PDF to a new email and send it to{" "}
                      <a href={`mailto:${RECIPIENT}`} className="font-semibold text-blue-900 hover:underline">{RECIPIENT}</a>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="font-bold shrink-0 text-blue-900">2.</span>
                    <span>Send the PDF via{" "}
                      <a href="https://wa.me/923008256203" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#1a8a37] hover:underline inline-flex items-center gap-1">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-1">
                <div className="relative">
                  {pdfState === "idle" && (
                    <span className="absolute inset-0 rounded-lg border-2 border-gold animate-ping opacity-60 pointer-events-none" aria-hidden="true" />
                  )}
                  <button
                    type="button"
