...
const PAGE_BOXES = [
  {
    ...
    image: "/images/hero/hero-apparel-fabric.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-bath-linen.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-bed-linen.webp",
  ...
  },
  {
    ...
    image: "/images/hero/hero-kitchen-linen.webp",
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 w-full">
          <div className="max-w-3xl">
              ...
              <span aria-hidden="true">&#x203A;</span>
              <span className="text-gold">Home Textile Fabric</span>
            </motion.nav>
<motion.p
      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link prefetch={false} href="/knowledge/home-textile-fabric-guide/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📚</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Knowledge Hub</p>
              <p className="font-semibold text-navy-900">Home Textile Fabric Guide</p>
              <p className="text-xs text-gray-500 leading-relaxed">Terry, percale, sateen and woven constructions — GSM, width and spec guide.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">Read Article →</span>
            </Link>
            <Link prefetch={false} href="/guides/sourcing-home-textile-fabric-pakistan/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">📄</span>
              ...
              <p className="text-xs text-gray-500 leading-relaxed">GSM, width, certification and roll MOQ for international buyers.</p>
              <span className="text-xs font-semibold text-navy-900 group-hover:text-gold transition-colors mt-auto">View Guide →</span>
            </Link>
            <Link prefetch={false} href="/downloads/home-textile-fabric-reference/" className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-gold hover:shadow-md transition-all flex flex-col gap-3">
              <span className="text-2xl" aria-hidden="true">⬇️</span>
              <p className="text-xs font-semibold text-gold uppercase tracking-widest">Downloads</p>
              <p className="font-semibold text-navy-900">Home Textile Fabric Reference</p>
              <p className="text-xs text-gray-500 leading-relaxed">Terry, percale and sateen specifications — quick reference sheet.</p>
