...
// ─── Size range expansion map ─────────────────────────────────────────────────
// Maps each dropdown size-range option to its individual sizes for ratio inputs.
// Shared between RFQContent.tsx (wizard UI + email body) and rfq-pdf.ts (PDF output).

export const SIZE_RANGE_EXPANSION: Record<string, string[]> = {
  "XS–XL":                                    ["XS", "S", "M", "L", "XL"],
  ...
  // Baby & Kids age groups — each option maps to itself so ratio inputs appear
...
export const PRODUCT_OPTIONS: Record<string, ProductOptions> = {
  ...
  "Apparel Fabric": {
    constructionLabel: "Fabric Construction",
    constructionOptions: [
      // — Knitted —
      "Single Jersey (combed cotton)",
      "Single Jersey (CVC / Poly-Cotton)",
      "Microfiber Knit (polyester / PA-PE split-filament)",
      ...
      "Ripstop (poly-cotton / nylon)",
      "Linen / Linen-Cotton Blend",
      "Seersucker",
      // — Non-woven —
      "Non-Woven (polypropylene / SMS)",
      "Other",
    ],
    constructionOtherPlaceholder: "e.g. Bonded / laminated, Coated fabric, Cordura nylon",
    weightLabel: "GSM",
    weightPlaceholder: "e.g. 160 gsm (knit) — for fine shirting also specify yarn count (Ne), e.g. 40s poplin",
    ...
    designLabel: "Fabric State / Dye Method",
    printTypeOptions: [
      "Greige / Raw",
      "Bleached",
      "Piece Dyed — Reactive (cotton / cellulosic)",
      "Piece Dyed — Disperse (polyester / microfiber)",
      "Yarn Dyed",
      "Pigment Dyed",
    ...
    finishingOptions: [
      "Soft hand / Silicone",
      "Anti-pill",
      "Anti-shrink / Compacted",
      "Enzyme treatment / Bio-finish",
      "Peached / Sueded",
      "Brushed",
      "Moisture Wicking",
      "Quick-Dry",
    ...
    individualPackOptions: [
      "50m per roll (≈5–25 kg)", "100m per roll (≈10–50 kg)",
      "150m per roll (≈15–70 kg)", "200m per roll (≈20–90 kg)",
      "Per kg (knit — sold by weight)", "Custom / To be confirmed",
    ],
  ...
  "Home Textile Fabric": {
    ...
    constructionOptions: [
      // — Terry —
      "Terry Loop (100% cotton)",
      "Velour / Sheared Terry",
      "Zero Twist Terry",
      "Microfiber Terry (polyester / PA-PE split-filament)",
      "Waffle / Honeycomb",
      "Dobby Stripe Terry",
      "Bamboo-Cotton Terry",
      // — Woven (bedding & linen) —
      "Percale (200–400 TC)",
      "Sateen (300–800 TC)",
      "Oxford Weave (institutional)",
      "Flannel / Brushed Cotton",
      "Jacquard (custom woven pattern)",
      "Plain Weave",
      "Twill (table / kitchen linen)",
      "Jersey Knit (stretch bedding)",
      "Microfiber Woven (polyester)",
      "Bamboo-Cotton Woven",
      "Linen-Cotton Woven",
      "Other",
    ],
    constructionOtherPlaceholder: "e.g. Dobby border terry, Fouta flat weave, Non-woven",
    weightLabel: "GSM / Thread Count",
    weightPlaceholder: "e.g. 500 gsm (terry) or 300 TC (bedding woven)",
    sizeLabel: "Fabric Width",
    sizeOptions: [
      "44\" / 112 cm", "58–60\" / 147–152 cm", "72\" / 183 cm",
    ...
    printTypeOptions: [
      "Greige / Raw",
      "Bleached (terry — ≥90 CIE whiteness)",
      "Piece Dyed — Reactive (cotton / bamboo)",
      "Piece Dyed — Disperse (polyester / microfiber terry)",
      "Yarn Dyed",
      "Printed (reactive / pigment)",
      "Jacquard woven pattern",
      "To be discussed",
    ...
    printPlacementLabel: "Pattern",
    printPlacementOptions: [
      "Solid / piece dyed", "Yarn dyed stripe / border", "All-over print",
      "Jacquard woven", "Plain greige / bleached",
    ],
    finishingOptions: [
      "Soft hand / Silicone",
      "Anti-bacterial",
      "Anti-shrink",
      "Velour / Shearing finish",
      "Quick-Dry Treatment",
      "Moisture Wicking",
      "Chlorine Resistant",
      "Zero-Twist (temporary PVA size — washes out after first launder)",
      "Wrinkle Resistant",
      "Flame Retardant (FR)",
      "No special finish",
    ],
    individualPackOptions: [
      "50m per roll (≈25–45 kg terry / 5–10 kg bedding)",
      "100m per roll (≈50–90 kg terry / 10–20 kg bedding)",
      "150m per roll (≈75–135 kg terry / 15–30 kg bedding)",
      "200m per roll (≈100–180 kg terry / 20–40 kg bedding)",
